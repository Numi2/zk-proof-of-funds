...
mod full_verification_flow_tests {
    ...
    fn test_full_native_verification_flow() {
        ...
        let ipa_proof = NativeIpaProof {
            ...
            final_a: proof.ipa_proof.final_eval.clone(),
            blinding: proof.ipa_proof.blinding.clone(),
        };
    ...
    fn test_linearization_alpha_powers() {
        ...
        assert!(result.gate_contributions.len() > 0 || result.linearization_eval.is_zero());
