...
const CATEGORY_LABELS: Record<string, string> = {
  ...
  AXELAR_COSMOS: 'Cosmos broadcast',
  AXELAR_L2: 'L2 broadcast',
  AXELAR_CREDIT: 'Credit line',
  MINA_HUB: 'Mina recursive',
  MINA_INSTITUTIONAL: 'Institutional',
  MINA_AGGREGATED: 'Multi-rail aggregated',
  USDC: 'USDC stablecoin',
  USDC_STARKNET: 'USDC (Starknet)',
  BOUND_IDENTITY: 'Identity-bound',
};
...
const RAIL_LABELS: Record<string, string> = {
  ...
  MINA_RECURSIVE: 'Mina recursive',
  PROVIDER_BALANCE_V2: 'Provider balance',
  BOUND_IDENTITY: 'Identity-bound',
};
