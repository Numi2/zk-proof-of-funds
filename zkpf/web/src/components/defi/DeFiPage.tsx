...
type Tab = '1click-swap' | 'near-intents' | 'axelar' | 'starknet' | 'omni';

export const DeFiPage: React.FC = () => {
  const [activeTab, setActiveTab] = useState<Tab>('1click-swap');

  return (
    <NearProvider defaultNetwork={NEAR_INTENTS_CONFIG.networkId}>
      <div className="defi-page">
        ...
        <div className="defi-tabs">
          <button
            onClick={() => setActiveTab('1click-swap')}
            className={`defi-tab ${activeTab === '1click-swap' ? 'active' : ''}`}
          >
        ...
        <div className="defi-content">
          {activeTab === '1click-swap' && <OneClickSwap />}
