...
pub struct ZkpfPublicInputs {
    ...
    pub custodian_pubkey_hash: felt252,
    // Starknet-specific (use felt252 for large chain IDs)
    pub chain_id_numeric: felt252,
    pub snapshot_block_number: u64,
    pub account_commitment: felt252,
...
#[starknet::interface]
pub trait IZkpfVerifier<TContractState> {
...
pub mod ErrorCodes {
    ...
    pub const EPOCH_DRIFT: felt252 = 'EPOCH_DRIFT';
    pub const NULLIFIER_REPLAY: felt252 = 'NULLIFIER_REPLAY';
    pub const POLICY_MISMATCH: felt252 = 'POLICY_MISMATCH';
    pub const CHAIN_MISMATCH: felt252 = 'CHAIN_MISMATCH';
    pub const THRESHOLD_NOT_MET: felt252 = 'THRESHOLD_NOT_MET';
}

#[starknet::contract]
pub mod ZkpfVerifierContract {
    ...
    // Starknet chain IDs (as felt252 for large values)
    const SN_MAIN_CHAIN_ID: felt252 = 0x534e5f4d41494e; // "SN_MAIN"
    const SN_SEPOLIA_CHAIN_ID: felt252 = 0x534e5f5345504f4c4941; // "SN_SEPOLIA"
...
#[starknet::interface]
pub trait IZkpfGated<TContractState> {
...
#[starknet::contract]
pub mod ZkpfGatedLending {
    use super::{IZkpfGated, IZkpfVerifierDispatcher, IZkpfVerifierDispatcherTrait};
